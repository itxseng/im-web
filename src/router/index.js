        ...
        children: [
          {
            ...
            component: () => import("../view/User/UserEquipment"),
          },
          {
            name: "Privacy",
            path: "/home/user/privacy",
            component: () => import("../view/User/UserPrivacy"),
          },
          {
            name: "Blacklist",
            path: "/home/user/blacklist",
            component: () => import("../view/User/privacy/UserBlacklist"),
          },
          {
            name: "UserInfo",
          ...
          {
            name: "Pyq",
            path: "/home/user/userPyq",
            component: () => import("../view/User/UserPyq"),
          },
        ]
      }
    ]
